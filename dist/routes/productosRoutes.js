...
produtosRoutes.post('/productos', upload.single('imagen'), ProducsController_1.createProducts);
produtosRoutes.get('/productos/imagen/:image', ProducsController_1.getImagenes);
produtosRoutes.delete('/productos/:id/', ProducsController_1.deleteProducts);
